...
class neko_list_sum_reduce_agent(neko_module_wrapping_agent):
    INPUT_srcs="inputs";
    OUTPUT_dst = "dst";
...
class neko_list_mul_agent(neko_module_wrapping_agent):
    INPUT_srcs="inputs";
    OUTPUT_dst = "dst";
...
if __name__ == '__main__':
    neko_list_sum_reduce_agent.print_default_setup_scripts()