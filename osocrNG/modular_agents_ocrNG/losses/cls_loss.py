...
class per_inst_ocr_cls_loss_agent_mk2(cls_loss_agent_mk2):
    ...
    def set_mod_io(this, iocvt_dict, modcvt_dict):
        ...
        this.inst_mapping = this.register_input(this.INPUT_inst_mapping_name, iocvt_dict);

    def take_action(this, workspace: neko_workspace, environment: neko_environment):
        per_inst_ocrloss = environment.module_dict[this.clsloss](
            workspace.get(this.predcls),workspace.get(this.clslabel),workspace.get(this.inst_mapping));
        workspace.add(this.lossname, per_inst_ocrloss);
        return workspace, environment;
    @classmethod
    def get_agtcfg(cls,
                   cls_label_name, cls_logit_name, flatten_map,
                   ocr_loss_name,
                   osocr_loss_mod_name
                   ):
        return {"agent": cls, "params": {
            "iocvt_dict": {cls.INPUT_cls_label_name: cls_label_name, cls.INPUT_cls_logit_name: cls_logit_name, cls.INPUT_inst_mapping_name:flatten_map,
                           cls.OUTPUT_ocr_loss_name: ocr_loss_name},
            "modcvt_dict": {cls.MOD_osocr_loss_mod_name: osocr_loss_mod_name}}}
class cls_loss_agent_mk2_debugger(neko_module_wrapping_agent):
    ...
    def set_mod_io(this, iocvt_dict, modcvt_dict):
        ...
        this.cls_mapping_name = this.register_input(this.INPUT_inst_mapping_name, iocvt_dict);
    ...
    def get_agtcfg(cls,
        ...
        return {"agent": cls, "params": {
            "iocvt_dict": {cls.INPUT_cls_label_name: cls_label_name, cls.INPUT_inst_mapping_name: cls_mapping_name,
...
osocr_loss_mod_name,
    ...
    return {"agent": engine, "params": {"iocvt_dict": {engine.INPUT_cls_label_name: cls_label_name, engine.INPUT_cls_logit_name: cls_logit_name, engine.INPUT_inst_mapping_name: cls_mapping_name, engine.OUTPUT_ocr_loss_name: ocr_loss_name}, "modcvt_dict": {engine.MOD_osocr_loss_mod_name: osocr_loss_mod_name}}}
