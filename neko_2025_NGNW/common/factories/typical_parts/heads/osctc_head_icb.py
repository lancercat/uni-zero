...
from neko_2025_NGNW.common.factories.components.heads.pred.beam_search_ctc import ctc_training_extra_agt_factory,ctc_pred_agt_factory,ctc_mod_factory,ctc_pred_agt_factory
...
class neko_object320_osctc_head_factory(neko_object320_virtual_head_factory):
    ...
    def __init__(this,platformcfg:neko_platform_cfg,gmodcfg:global_mod_cfg,external_factory_dict=None):
        ...
        this.ctc_modf=ctc_mod_factory(gmodcfg,{});
        this.pred_ctc_agtf=ctc_pred_agt_factory();
        this.train_ctc_agtf=ctc_training_extra_agt_factory();
    ...
    def arm_head_mods(this, modcfg, bogocfg, endpoint_mod_prfx,tcfg):
        ...
        this.ctc_modf.arm_module({this.ctc_modf.MOD_PRFX_local: endpoint_mod_prfx }, modcfg,bogocfg);
    ...
    def arm_pred_agent(this,acfg,meta_data_prefix,endpoint_mod_prfx,feat_data_prfx,endpoint_data_prefix):
        ...
        this.pred_ctc_agtf.arm_agt_core({
            this.pred_ctc_agtf.MOD_PRFX_local:endpoint_mod_prfx,
        }, {
            this.pred_ctc_agtf.DATA_PRFX_meta: meta_data_prefix,
            this.pred_ctc_agtf.DATA_PRFX_roiseq_feat: feat_data_prfx,
            this.pred_ctc_agtf.DATA_PRFX_local: endpoint_data_prefix
        }, acfg, AN.DCLS(endpoint_data_prefix), {});
        return acfg;
    ...
    def arm_training_agent(this,acfg,meta_data_prefix,endpoint_mod_prfx,feat_data_prfx,endpoint_data_prefix,training_endpoint_data_prfx):
        ...
        acfg=this.train_ctc_agtf.arm_agt_core(
            {this.train_ctc_agtf.MOD_PRFX_local:endpoint_mod_prfx},{
            this.train_ctc_agtf.DATA_PRFX_meta: meta_data_prefix,
            this.train_ctc_agtf.DATA_PRFX_pred_endpoint: endpoint_data_prefix,
            this.train_ctc_agtf.DATA_PRFX_roiseq_feat: feat_data_prfx,
            this.train_ctc_agtf.DATA_PRFX_local: training_endpoint_data_prfx,
            this.train_ctc_agtf.DATA_PRFX_gt:feat_data_prfx,
