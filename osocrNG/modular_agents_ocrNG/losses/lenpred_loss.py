...
class per_inst_len_loss_agent_mk2(ocr_loss_agent_mk2):
    ...
    def get_agtcfg(cls,
        ...
        return {"agent": cls, "params": {
            "iocvt_dict": {cls.INPUT_len_label_name: len_label_name, cls.INPUT_len_logit_name: len_logit_name,
                           cls.OUTPUT_len_loss_name: len_loss_name},
            "modcvt_dict": {cls.MOD_osocr_length_loss_mod_name: osocr_length_loss_mod_name}}}
...
if __name__ == '__main__':
    per_inst_len_loss_agent_mk2.print_default_setup_scripts()
