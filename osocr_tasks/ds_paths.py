...
def get_istr_odia_test(root="/home/lasercat/ssddata/"):
    return os.path.join(root,"istr","odia_test");
def get_istr_odia_val(root="/home/lasercat/ssddata/"):
    return os.path.join(root,"istr","odia_val");
def get_istr_odia_train(root="/home/lasercat/ssddata/"):
    return os.path.join(root,"istr","odia_train");
