...
def getpaddedsize(text_width,text_height):
    return int(text_width*1.1),int(text_width*1.1);
...
def _generate_horizontal_text(
    ...
    txt_img = Image.new("RGBA", getpaddedsize(text_width, text_height), (0, 0, 0, 0))
...
def _generate_vertical_text(
    ...
    txt_img = Image.new("RGBA", getpaddedsize(text_width, text_height), (0, 0, 0, 0))
    txt_mask = Image.new("RGBA", getpaddedsize(text_width, text_height), (0, 0, 0, 0))
