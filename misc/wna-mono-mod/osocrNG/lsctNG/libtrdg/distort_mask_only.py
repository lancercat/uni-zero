...
def _apply_func_distorsion(mask, vertical, horizontal, max_offset, func):
    """
...
def sin( mask, vertical=False, horizontal=False):
    """
...
def cos(mask, vertical=False, horizontal=False):
    """
...
def random(mask, vertical=False, horizontal=False):
    """
