class init_layer_g3:
    ...
    def __call__(this,x):
        ...
        b=this.bn(a);
        return this.relu(b);
class last_layer_g3_simple:
    def __init__(this, layer_dict,bn_dict,layer_container,bn_container):
        this.conv=layer_container[layer_dict["conv"]];
    def __call__(this,x):
        return this.conv(x);

class BasicBlock_ass_g3:
    def __init__(this,  layer_dict,bn_dict,layer_container,bn_container):
...
class dan_reslayer_g3:
    BLK=BasicBlock_ass_g3
    def __init__(this,  layer_dict,bn_dict,layer_container,bn_container):
        this.blocks=[];
    ...
    def __call__(this,x):
        for l in this.blocks:
            x=l(x);
        return x;
class BasicBlock_ass_mask_g3(BasicBlock_ass_g3):
...
class dan_reslayer_mask_g3(dan_reslayer_g3):
    BLK=BasicBlock_ass_mask_g3;
    def __call__(this,x,mask):
        for l in this.blocks:
            x,mask=l(x,mask);
        return x,mask;