...
class neko_simple_map_tower_to_vec_aaggr_agent_builder:
    @classmethod
    def arm_sampling(cls,acfg,
                   tensor_featmap_name,feature_tower, tensor_att_name,mod_att_name):
    ...
    def arm_core_agtcfg(cls,acfg,
                   tensor_featmap_name,feature_tower, tensor_att_name, tensor_vec_name,
                   mod_att_name,  mod_drop_name
                   ):
    ...
    @classmethod
    def get_agtcfg(cls,
                   tensor_featmap_name, feature_tower, tensor_att_name, tensor_vec_name, mod_att_name, mod_drop_name):
        acfg=awa.empty();
        cls.arm_core_agtcfg(acfg,tensor_featmap_name,feature_tower, tensor_att_name, tensor_vec_name,
                   mod_att_name,  mod_drop_name);
        return acfg;


class neko_map_tower_to_vec_aaggr_agent_builder:
    @classmethod
    def arm_sampling(cls,acfg,
        ...
        acfg = awa.append_agent_to_cfg(acfg, "se", neko_simple_action_module_wrapping_agent_1i1o_basic.get_agtcfg(
            local_temp_feat_name, local_temp_feat_se_name, mod_se_name
        ));
        acfg = awa.append_agent_to_cfg(acfg, "attn", neko_simple_action_module_wrapping_agent_1i1o_basic.get_agtcfg(
            local_temp_feat_se_name, tensor_att_name, mod_att_name
        ));
        return acfg
    @classmethod
    def arm_core_agtcfg(cls,acfg,
                   tensor_featmap_name,feature_tower, tensor_att_name, tensor_vec_name,
                   mod_se_name,mod_att_name,  mod_drop_name
                   ):
        acfg= cls.arm_sampling(acfg,
                   tensor_featmap_name,feature_tower, tensor_att_name,
                   mod_se_name,mod_att_name)
...
class neko_map_tower_to_vec_aaggr_agent_builder_detach:
    @classmethod
    def arm_sampling(cls,acfg,
                   tensor_featmap_name,feature_tower, tensor_att_name,
                   mod_se_name,mod_att_name):
        ...
        local_temp_feat_name=P(tensor_featmap_name,"temp_feat");
        local_temp_feat_detach_name=P(local_temp_feat_name,"detached"); # private variables. They will be in the workspace but you are never expected to use them elsewhere.
        local_temp_feat_se_name=P(local_temp_feat_name,"spatial_embedded");
        acfg=awa.append_agent_to_cfg(acfg,"pick_tf",neko_fetch_from_list.get_agtcfg(
            feature_tower,local_temp_feat_name,0
        ));
        acfg = awa.append_agent_to_cfg(acfg, "detach_tf", neko_detach_agent.get_agtcfg(
            local_temp_feat_name,local_temp_feat_detach_name,
        ));
        acfg = awa.append_agent_to_cfg(acfg, "se", neko_simple_action_module_wrapping_agent_1i1o_basic.get_agtcfg(
            local_temp_feat_detach_name, local_temp_feat_se_name, mod_se_name
        ));
        acfg = awa.append_agent_to_cfg(acfg, "attn", neko_simple_action_module_wrapping_agent_1i1o_basic.get_agtcfg(
            local_temp_feat_se_name, tensor_att_name, mod_att_name
        ));
