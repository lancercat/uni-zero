...
from neko_2025_NGNW.common.object_32x_presets.tasks.taskgrps.istr_lst import arm_istr_zslc_bengali_gujarati_fix
...
def arm_taskgrp(pcfg,tome):
    ...
    tome =arm_istr_zslc_bengali_gujarati_fix(pcfg,tome,lsct=False);
