...
from neko_sdk.encoders.chunked_resnet.neko_block_fe import make_body_layer_bn, make_init_layer_bn, \
    make_init_layer_wo_bn, make_body_layer_wo_bn,make_fin_layer_wo_bn


# Well the details are handed over to configs now.
def res45g3_wo_bn(inpch,strides,ochs,blkcnt,inplace=True,engine=nn.Conv2d):
    retlayers={};
    ...
    retlayers["fin"]=make_fin_layer_wo_bn(ochs[5],ochs[5],1,inplace,engine);
    return retlayers;


def res45g3_bn(strides,ochs,blkcnt,affine=True,engine=nn.BatchNorm2d):
    retlayers = {};
