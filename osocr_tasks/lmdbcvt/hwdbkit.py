...
from neko_2020nocr.dataset_adaptors.olhwdbcvt import sample_data
...
def draw(strokes,stroke_width):
    ...
    for stroke in strokes:
        ...
        draw.line(stroke, fill=0, width=stroke_width)
    del draw
...
def convert_pot(pot_dir, fn_dst,sw=4):
...
#
# convert_pot(trn_pot_dir, "/home/lasercat/datasets/OLHWDB1.1trn_pot.bin")
