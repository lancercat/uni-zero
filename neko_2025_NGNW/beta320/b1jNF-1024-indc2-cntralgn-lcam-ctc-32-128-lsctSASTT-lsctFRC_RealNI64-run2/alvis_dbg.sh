...
PATHLOGDIR="/mimer/NOBACKUP/groups/document_analysis_alvis/chang_assets/hydra_logs_extra/watch_and_build/dbg/${MTHDNAME}_allruns/${CURRENTDATE}_ID_${IDRUN}/"
MTHDLOGDIR="/mimer/NOBACKUP/groups/document_analysis_alvis/chang_assets/hydra_logs_extra/watch_and_build/dbg/${MTHDNAME}"
echo "path log dir:"
echo ${PATHLOGDIR}
mkdir -p ${PATHLOGDIR}
rm ${MTHDLOGDIR}
...
python3 train_d.py ${PATHCONFIGGPU} 2>&1 | tee ${PATHLOG}
