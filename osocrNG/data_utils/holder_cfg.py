...
def get_cvpr_2016_holder(dataroot):
    return neko_im_label_lmdb_holder({"root": get_cvpr16(dataroot)});


def get_nips_2014_holder(dataroot):
    return neko_im_label_lmdb_holder({"root": get_nips14(dataroot)});

def get_fudanvi_scene_tr_holder(dataroot):
    return neko_im_label_lmdb_holder({"root":get_fudanvi_scene_train(dataroot)});

def get_fudanvi_web_tr_holder(dataroot):
    return neko_im_label_lmdb_holder({"root":get_fudanvi_web_train(dataroot)});
def get_fudanvi_hwdb_tr_holder(dataroot):
    return neko_im_label_lmdb_holder({"root":get_fudanvi_hwdb_train(dataroot)});
def get_fudanvi_doc_tr_holder(dataroot):
    return neko_im_label_lmdb_holder({"root":get_fudanvi_document_train(dataroot)});

def get_fudanvi_scene_te_holder(dataroot):
    return neko_im_label_lmdb_holder({"root":get_fudanvi_scene_test(dataroot)});

def get_fudanvi_web_te_holder(dataroot):
    return neko_im_label_lmdb_holder({"root":get_fudanvi_web_test(dataroot)});
def get_fudanvi_hwdb_te_holder(dataroot):
    return neko_im_label_lmdb_holder({"root":get_fudanvi_hwdb_test(dataroot)});
def get_fudanvi_doc_te_holder(dataroot):
    return neko_im_label_lmdb_holder({"root":get_fudanvi_document_test(dataroot)});
...
def get_abi_mj_tr_holder(dataroot):
    return neko_im_label_lmdb_holder({"root": get_mj_tr_abi(dataroot)});

def get_abi_mj_val_holder(dataroot):
    return neko_im_label_lmdb_holder({"root": get_mj_val_abi(dataroot)});

def get_abi_mj_te_holder(dataroot):
    return neko_im_label_lmdb_holder({"root": get_mj_te_abi(dataroot)});

def get_abi_st_holder(dataroot):
    return neko_im_label_lmdb_holder({"root": get_st_abi(dataroot)});
