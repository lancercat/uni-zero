...
class neko_fetching_and_dispatching_agent(neko_abstract_async_agent_gen1):
...
class neko_fetching_and_dispatching_servant(neko_abstract_async_agent_gen1):
    def setup(this,param):
...
class neko_balance_fetching_and_dispatching_agent(neko_abstract_async_agent_gen1):
    ...
    def setup(this,param):
        ...
        try:
            training_ranges=[
                param["anchor_cfg"][k]["training_ar_range"] for k in this.anchor_names];
        except:
