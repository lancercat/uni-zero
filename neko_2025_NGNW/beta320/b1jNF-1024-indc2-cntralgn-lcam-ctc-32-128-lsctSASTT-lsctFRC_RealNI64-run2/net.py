...
from neko_2025_NGNW.common.factories.presets.neko_320_netbuilder import neko_object320_oscr_no_route_norm_feat_lcam_ctc_lsctrest_ind_sem_corrw05
...
def get_tra(pcfg,tome,vitr=100000,vepo=5):
    ...
    nf = neko_object320_oscr_no_route_norm_feat_lcam_ctc_lsctrest_ind_sem_corrw05(pcfg, {
